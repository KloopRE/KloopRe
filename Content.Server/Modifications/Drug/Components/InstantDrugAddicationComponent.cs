...
namespace Content.Server.Modifications.Drug.Components;
...
public sealed partial class InstantDrugAddicationComponent : Component
{
    ...
    [DataField]
    [ViewVariables(VVAccess.ReadOnly)]
    public SoundSpecifier? SoundHighEffect = new SoundPathSpecifier("/Audio/Modifications/Drug/high_effect.ogg");
